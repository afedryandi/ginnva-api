...
/**
 * Sama pola dengan RawMaterialResource\RelationManagers\ActivityLogRelationManager
 * — sebelumnya perubahan (nama, harga, ambang stok menipis, dst) sudah
 * tercatat di activity_log, tapi tidak ada tempat melihatnya dari menu
 * Barang Habis Pakai, cuma bisa lewat "Histori Aktivitas" global yang
 * mencampur semua modul.
 */
class ActivityLogRelationManager extends RelationManager
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->emptyStateDescription('Perubahan pada barang ini (nama, harga, ambang stok menipis, dst) otomatis tercatat di sini.');
    }
