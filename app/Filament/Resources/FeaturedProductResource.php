...
class FeaturedProductResource extends Resource
{
     ...
     * FeaturedProductPolicy terdaftar — canCreate()/canEdit()/canDelete()
     * bawaan Resource selalu FALSE untuk siapa pun tanpa policy
     * (default-deny Laravel). Akibatnya tombol "New", "Edit", DAN "Hapus"
     * tidak pernah muncul — admin sama sekali tidak bisa kelola Seri
     * Produk (Beranda) lewat Filament. Ditemukan saat audit modul
     * Marketing > Katalog Reward (sama bug class yang berulang di
     * beberapa Resource lain sesi ini).
     */
