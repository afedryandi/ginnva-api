 ...
 * null di sana, membocorkan performa reservasi seluruh perusahaan ke
 * staff toko manapun. Fallback auth()->user() + pindah namespace
 * menutup celahnya sekaligus akar masalahnya (sama pola InventoryWidgets).
 */
