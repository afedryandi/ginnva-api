            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="border-b border-gray-200 text-left text-xs text-gray-500 dark:border-white/10 dark:text-gray-400">
                        ...
                        <th class="whitespace-nowrap py-2 px-3">Tanggal Terima</th>
                        <th class="whitespace-nowrap py-2 px-3">Tanggal Kedaluwarsa</th>
                        <th class="whitespace-nowrap py-2 px-3 text-right">Sisa Qty</th>
                        <th class="whitespace-nowrap py-2 px-3 text-right">Nilai</th>
