<x-filament-panels::page>
    ...
    <x-filament::section>
        ...
        <x-slot name="description">Diambil dari histori aktivitas (log perubahan status), bukan kolom terpisah — "Pelaku" bisa "Sistem" kalau dibatalkan lewat proses otomatis.</x-slot>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="6" class="py-4 text-center text-gray-500 dark:text-gray-400">Tidak ada booking dibatalkan pada rentang ini.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
